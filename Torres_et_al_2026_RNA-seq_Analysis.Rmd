...
countdataInteractors <- read.table("bed_csv_txt_files/readcounts_All_CAF1paper.merged.txt", header=TRUE,stringsAsFactors=FALSE, row.names=1, check.names=FALSE, sep="\t")
...
Prc2targets <- read.table("bed_csv_txt_files/H3K27me3_methylated_genes_FINAL.bed", header=FALSE, stringsAsFactors=FALSE, check.names=FALSE, sep="\t") 
...
coldata <- read.csv("bed_csv_txt_files/coldata.csv", header= TRUE, row.names = 1)
...
deg_map <- export_deseq_csvs(
  ...
  neurospora_bed_path = "bed_csv_txt_files/neurospora_genes_edit.bed",
  prc2_targets_path   = "bed_csv_txt_files/H3K27me3_methylated_genes_FINAL.bed",
  lfc_cutoff = 1.0,
  alphas = c(0.05, 0.01)
)
...
de_csv_path     <- "bed_csv_txt_files/cac1_cac2__alpha0.05__DE_intersection.csv"
...
## --- paths / outputs ---
fungidb_go_path <- "Nc_GO_mapping.txt"
de_csv_path <- "bed_csv_txt_files/cac1_cac2__alpha0.05__UP_intersection.csv"
...
## --- paths / outputs ---
fungidb_go_path <- "Nc_GO_mapping.txt"
de_csv_path     <- "bed_csv_txt_files/cac1_cac2__alpha0.05__DOWN_intersection.csv"
...
## --- paths / outputs ---
fungidb_go_path <- "Nc_GO_mapping.txt"
de_csv_path     <- "bed_csv_txt_files/cac1_suz12__alpha0.05__UP_genes.csv"
...
## --- paths / outputs ---
fungidb_go_path <- "Nc_GO_mapping.txt"
de_csv_path     <- "bed_csv_txt_files/cac1_suz12__alpha0.05__DOWN_genes.csv"
...
all_genes <- read.csv("bed_csv_txt_files/cac1__alpha0.05__ALL_results_LFC.csv")
...
FP_DE_genes <- read.table(file = "bed_csv_txt_files/FP_DE_genes.txt", header=TRUE, stringsAsFactors=FALSE, row.names=NULL, check.names=FALSE, sep="\t")
...
########################################################################################
###GO Analysis on genes upregulated in set-7
set7_DE_genes <- read.table(file = "bed_csv_txt_files/set7_DE_genes.txt", header=TRUE, stringsAsFactors=FALSE, row.names=NULL, check.names=FALSE, sep="\t")
...
cac1_vol <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac1__alpha0.05__ALL_results_LFC.csv")
cac2_vol <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac2__alpha0.05__ALL_results_LFC.csv")
cac3_vol <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac3__alpha0.05__ALL_results_LFC.csv")
set7_vol <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/set7__alpha0.05__ALL_results_LFC.csv")
cac1_suz12_vol <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac1_SUZ12__alpha0.05__ALL_results_LFC.csv")
...
cac1UP <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac1__alpha0.05__UP_genes.csv")
cac2UP <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac2__alpha0.05__UP_genes.csv")
cac3UP <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac3__alpha0.05__UP_genes.csv")
set7UP <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/set7__alpha0.05__UP_genes.csv")

cac1DOWN <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac1__alpha0.05__DOWN_genes.csv")
cac2DOWN <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac2__alpha0.05__DOWN_genes.csv")
cac3DOWN <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac3__alpha0.05__DOWN_genes.csv")
set7DOWN <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/set7__alpha0.05__DOWN_genes.csv")

cac1_K27 <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac1__alpha0.05__K27_UP_genes.csv")
cac2_K27 <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac2__alpha0.05__K27_UP_genes.csv")
cac3_K27 <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac3__alpha0.05__K27_UP_genes.csv")
set7_K27 <- read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/set7__alpha0.05__K27_UP_genes.csv")
...
set7_RNA_K27 = read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/set7__alpha0.05__K27_UP_genes.csv")
suz12_RNA_K27 = read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/suz12__alpha0.05__K27_UP_genes.csv")
ash1_RNA_K27 = read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/ash1__alpha0.05__K27_UP_genes.csv")
cac1_RNA_K27 = read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac1__alpha0.05__K27_UP_genes.csv")
cac1_cac2RNA_K27 = read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac1_cac2__alpha0.05__K27_UP_genes.csv")
cac1_suz12RNA_K27 = read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac1_suz12__alpha0.05__K27_UP_genes.csv")
...
list_of_files <- list.files(path = "bed_csv_txt_files",
                            recursive = FALSE,
                            pattern = ".csv$")
...
ngenes = read.csv("bed_csv_txt_files/csv_files/neurospora_genes_edit.csv")
