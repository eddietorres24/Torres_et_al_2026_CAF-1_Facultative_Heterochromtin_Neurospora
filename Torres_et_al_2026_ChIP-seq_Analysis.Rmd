...
regions <- list(allgenes_promTSSext = read.table("bed_csv_txt_files/allgenespromTSSext.bed"), allgenespromTSS = read.table("bed_csv_txt_files/allgenes_promTSS.bed")) 

#original list
# list(K27genes_proms = read.table("bed_csv_txt_files/K27_genes_prom_100pct_overlap.bed"), K27genes = read.table("bed_csv_txt_files/K27_genes_stringent.bed"), K27proms = read.table("bed_csv_txt_files/K27_promoters.bed"), K27promTSS = read.table("bed_csv_txt_files/K27_prom_TSS.bed"), allgenes = read.table("bed_csv_txt_files/all_genes_forR.bed"), K27promTSSext = read.table("bed_csv_txt_files/K27promTSSext.bed"), allgenespromTSS = read.table("bed_csv_txt_files/allgenes_promTSS.bed"), allgenes_promTSSext = read.table("bed_csv_txt_files/allgenespromTSSext.bed")) 

#K27genes_proms = read.table("bed_csv_txt_files/K27_genes_prom_100pct_overlap.bed"), K27genes = read.table("bed_csv_txt_files/K27_genes_stringent.bed"), K27proms = read.table("bed_csv_txt_files/K27_promoters.bed"), K27promTSS = read.table("bed_csv_txt_files/K27_prom_TSS.bed"), allgenes = read.table("bed_csv_txt_files/all_genes_forR.bed"), K27promTSSext = read.table("bed_csv_txt_files/K27promTSSext.bed"), 

new = read.table("bed_csv_txt_files/H3K27me3_methylated_genes_FINAL.bed")
...
##############################
#H3K36me3_Results_allgenes_vInput = read.table("bed_csv_txt_files/CAF-1_Full_genome_Analysis/H3K36me3_Results_K27promTSS_vInput.csv", sep = ",", header = TRUE)
