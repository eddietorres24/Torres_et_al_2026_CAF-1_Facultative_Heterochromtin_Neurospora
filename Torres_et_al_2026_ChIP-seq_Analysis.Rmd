...
#reading in metdata
meta <- read.csv("bed_csv_txt_files/csaw_samples_files/cac_csaw_FINAL.csv")
#metaQC <- read.csv("bed_csv_txt_files/csaw_samples_files/cac_csaw_QC_TEST.csv")

#fix path (if necessary, should only need to do if you're in wrong directory)
#meta <- meta %>%
...
regions <- list(allgenes_promTSSext = read.table("bed_csv_txt_files/bed_files/allgenespromTSSext.bed"), allgenespromTSS = read.table("bed_csv_txt_files/bed_files/allgenes_promTSS.bed")) 

#original list
# list(K27genes_proms = read.table("bed_csv_txt_files/bed_files/K27_genes_prom_100pct_overlap.bed"), K27genes = read.table("bed_csv_txt_files/bed_files/K27_genes_stringent.bed"), K27proms = read.table("bed_csv_txt_files/bed_files/K27_promoters.bed"), K27promTSS = read.table("bed_csv_txt_files/bed_files/K27_prom_TSS.bed"), allgenes = read.table("bed_csv_txt_files/bed_files/all_genes_forR.bed"), K27promTSSext = read.table("bed_csv_txt_files/bed_files/K27promTSSext.bed"), allgenespromTSS = read.table("bed_csv_txt_files/bed_files/allgenes_promTSS.bed"), allgenes_promTSSext = read.table("bed_csv_txt_files/bed_files/allgenespromTSSext.bed")) 

#K27genes_proms = read.table("bed_csv_txt_files/bed_files/K27_genes_prom_100pct_overlap.bed"), K27genes = read.table("bed_csv_txt_files/bed_files/K27_genes_stringent.bed"), K27proms = read.table("bed_csv_txt_files/bed_files/K27_promoters.bed"), K27promTSS = read.table("bed_csv_txt_files/bed_files/K27_prom_TSS.bed"), allgenes = read.table("bed_csv_txt_files/bed_files/all_genes_forR.bed"), K27promTSSext = read.table("bed_csv_txt_files/bed_files/K27promTSSext.bed"), 

new = read.table("bed_csv_txt_files/bed_files/H3K27me3_methylated_genes_FINAL.bed")
...
#Reading in RNA dfs
cac1RNA= read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac1__alpha0.05__ALL_results_LFC.csv", row.names = 1)
cac2RNA= read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac2__alpha0.05__ALL_results_LFC.csv", row.names = 1)
cac3RNA= read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac3__alpha0.05__ALL_results_LFC.csv", row.names = 1)
set7RNA= read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/set7__alpha0.05__ALL_results_LFC.csv", row.names = 1)
ash1RNA= read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/ash1__alpha0.05__ALL_results_LFC.csv", row.names = 1)
cac1suz12RNA= read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/cac1_suz12__alpha0.05__ALL_results_LFC.csv", row.names = 1)
suz12RNA= read.csv("bed_csv_txt_files/CAF-1_RNA-seq_Analysis/csv_files/suz12__alpha0.05__ALL_results_LFC.csv", row.names = 1)
